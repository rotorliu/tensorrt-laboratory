...
foreach(search ${_TensorRT_SEARCHES})
  find_path(TensorRT_INCLUDE_DIR NAMES NvInfer.h NvInferPlugin.h NiInferPlugin.h ${${search}} PATH_SUFFIXES include)
endforeach()
...
if(NOT Navinfo_PLUGIN_LIBRARY)
  foreach(search ${_TensorRT_SEARCHES})
    find_library(Navinfo_PLUGIN_LIBRARY NAMES niinfer_plugin ${${search}} PATH_SUFFIXES lib)
  endforeach()
endif()
...
if(TensorRT_FOUND)
  ...
  if(NOT TARGET TensorRT::TensorRT)
    ...
    set_property(TARGET TensorRT::TensorRT APPEND PROPERTY IMPORTED_LOCATION "${TensorRT_LIBRARY}${TensorRT_PLUGIN_LIBRARY}${Navinfo_PLUGIN_LIBRARY}")
  endif()
endif()
